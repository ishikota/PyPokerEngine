...
class RoundManager:
    ...
    @classmethod
    def start_new_round(
        self, round_count, small_blind_amount, ante_amount, table, pocket_cards_map=None
    ):
        ...
        self.__deal_holecard(table.deck, table.seats.players, pocket_cards_map)
    ...
    @classmethod
    def __deal_holecard(self, deck, players, pocket_cards_map=None):
        for player in players:
            # Check if the player's name exists in pocket_cards_map and if it has a non-empty value
            player_name = player.name
            if pocket_cards_map and player_name in pocket_cards_map:
                pocket_cards = pocket_cards_map[player_name]
                if pocket_cards:
                    player.add_holecard(gen_cards(pocket_cards))
                else:
